angular.module('myApp').controller('ListUserController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'UserService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, UserService) {
	...
	function init() {
		SecurityService.getPermisionsFoResource('user').then(function(httpData) {
